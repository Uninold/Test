package com.agura.com.clocktimer.stopwatch
 ...
 * [StopWatch.OnFragmentInteractionListener] interface
...
class StopWatch : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): StopWatch {
            val fragment = StopWatch()
            val args = Bundle()
